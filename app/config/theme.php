...
return [
     ...
     */
    'views' => [
        ['region' => 'header', 'template' => 'theme/header', 'data' => ['siteTitle' => 'gardenshed | ', 'siteTagline' => 'stack exchange'], 'sort' => -1],
        ['region' => 'footer', 'template' => 'theme/footer', 'data' => [], 'sort' => -1],
        ['region' => 'navbar', 'template' => ['callback' => 
            function() { return $this->di->navbar->create(); },], 'data' => [], 'sort' => -1],
    ],
    ...
    'data' => [
        ...
        'title_append' => ' | GARDENSHED',

        // Stylesheets
        'stylesheets' => [
            'http://yui.yahooapis.com/pure/0.4.2/base-min.css', 
            'css/pure-min.css',
